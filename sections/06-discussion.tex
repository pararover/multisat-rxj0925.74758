\section{Discussion and Conclusions}
	...
	Earlier, Hartmann \textit{et al.} (1999) had applied non-local thermodynamic equilibrium (NLTE) models, which included metal line opacities, to the spectrum extracted from the observations by the LECS instrument on-board BeppoSAX observatory for \source\ on 25--26 January 1997, %\cite{hartmann1999constraining}
